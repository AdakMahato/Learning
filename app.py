...
configure_page()
sidebar("home")
st.markdown('''<div class="hero"><div class="eyebrow">INTERACTIVE DBMS CURRICULUM</div><h1>DBMS Story Lab</h1><p>Learn database systems by solving problems,<br>not memorizing definitions.</p><p style="font-size:.86rem;margin-top:.85rem">11 investigations &nbsp;•&nbsp; Interactive labs &nbsp;•&nbsp; Progressive difficulty</p></div>''', unsafe_allow_html=True)
